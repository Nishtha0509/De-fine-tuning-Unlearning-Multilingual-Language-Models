...
MODEL_CONFIGS = [
    ...
    #     model_path=f"/scratch/jsong132/De-fine-tuning-Unlearning-Multilingual-Language-Models/FineTuning/TOFU_Llamas-3.2-3B/Full_TOFU_Llamas-3.2-3B_ENG",
    #     is_local=True,
    #     is_adapter_model=False,
    # ),
    # ModelConfig(
    ...
    # ),
    ModelConfig(
        name="unlearned_model_gemma-3-4B-it_ENG",
        model_path=f"/scratch/jsong132/De-fine-tuning-Unlearning-Multilingual-Language-Models/Unlearning/unlearned_models/unlearned_model_gemma-3-4B-it_ENG",
        is_local=True,
        is_adapter_model=False,
    ),
    ModelConfig(
        name="unlearned_model_Llamas-3.2-3B_ENG",
        model_path=f"/scratch/jsong132/De-fine-tuning-Unlearning-Multilingual-Language-Models/Unlearning/unlearned_models/unlearned_model_Llamas-3.2-3B_ENG",
        is_local=True,
        is_adapter_model=False,
    ),
    ModelConfig(
        name="unlearned_model_Qwen2.5-7B-Instruct_ENG",
        model_path=f"/scratch/jsong132/De-fine-tuning-Unlearning-Multilingual-Language-Models/Unlearning/unlearned_models/unlearned_model_Qwen2.5-7B-Instruct_ENG",
        is_local=True,
        is_adapter_model=False,
    ),
]
